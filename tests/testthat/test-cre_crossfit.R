test_that("CRE Crossfit Runs Correctly", {
  ...
  expect_error(cre_crossfit(y = "test", z, X, ite_method_dis, include_ps_dis,
  ...
  expect_error(cre_crossfit(y, z = "test", X, ite_method_dis, include_ps_dis,
                            ps_method_dis, or_method_dis, ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf,  ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
                            cate_method, cate_SL_library, filter_cate))
  expect_error(cre_crossfit(y, z, X = "test", ite_method_dis, include_ps_dis,
                            ps_method_dis, or_method_dis, ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf, ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
  ...
  expect_error(cre_crossfit(y, z, X = NA, ite_method_dis, include_ps_dis,
                            ps_method_dis, or_method_dis, ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf, ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
                            cate_method, cate_SL_library, filter_cate))
  expect_error(cre_crossfit(y, z, X = 2, ite_method_dis, include_ps_dis,
                            ps_method_dis, or_method_dis, ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf, ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
  ...
  expect_error(cre_crossfit(y, z, X, ite_method_dis = 0, include_ps_dis,
                            ps_method_dis, or_method_dis, ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf, ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
                            cate_method, cate_SL_library, filter_cate))
  expect_error(cre_crossfit(y, z, X, ite_method_dis = "test", include_ps_dis,
                            ps_method_dis, or_method_dis, ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf, ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
  ...
  expect_error(cre_crossfit(y, z, X, ite_method_dis, include_ps_dis,
  ...
  expect_error(cre_crossfit(y, z, X, ite_method_dis = "aipw", include_ps_dis,
                            ...
                            cate_method, cate_SL_library, filter_cate))
  expect_error(cre_crossfit(y, z, X, ite_method_dis, include_ps_dis,
                            ps_method_dis, or_method_dis, ite_method_inf = "aipw", include_ps_inf,
                            ps_method_inf, or_method_inf = 0, ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
                            cate_method, cate_SL_library, filter_cate))

  # Incorrect include_ps input
  expect_error(cre_crossfit(y, z, X, ite_method_dis, include_ps_dis = "test",
                            ps_method_dis, or_method_dis, ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf, ntrees_rf, ntrees_gbm,
                            min_nodes, max_nodes, t, q, stability_selection, pfer_val,
                            include_offset, offset_name,
  ...
  expect_error(cre_crossfit(y, z, X, ite_method_dis,
  ...
  expect_error(cre_crossfit(y, z, X, ite_method_dis = "poisson",
                            include_ps_dis, ps_method_dis, or_method_dis,
                            ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf,
                            ntrees_rf, ntrees_gbm, min_nodes,
  ...
  expect_error(cre_crossfit(y_bin, z_bin, X_bin, ite_method_dis = "bcf",
                            include_ps_dis, ps_method_dis, or_method_dis,
                            ite_method_inf, include_ps_inf,
                            ps_method_inf, or_method_inf,
                            ntrees_rf, ntrees_gbm, min_nodes,
  ...
  # Correct outputs
  cre_results <- cre_crossfit(y, z, X, ite_method_dis, include_ps_dis,
